...
<head>
    ...
    <style>
        ...
        .background-column {
            background-image: url('https://detaalschool.com/wp-content/uploads/2018/08/cropped-startup-593341_1280.jpg');
            width: 900px;
            height: 800px;
    ...
    <div class=" ">
        <div class="row" style=" width: 100%;">
            ...
            <div class="col d-flex justify-content-center align-items-center">
                <div>
                    <h2 style="text-align:center; font-size: 40px; margin-bottom: 20px;">Silahkan Mengisi Data Anda!</h2>
                        ...
                        <table class="transparent-table td">
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <input type="checkbox" name="check1" value="Badminoton">Badminton
